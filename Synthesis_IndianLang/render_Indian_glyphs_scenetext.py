...
number_of_alphabets = 73
each_alphabet_repeated = 1000
total_iterations = (numWords - number_of_alphabets) + (number_of_alphabets * each_alphabet_repeated)
alphabet_iter = 1
word_iter = 0

# for i in range(2208880,total_iterations+2208880):
for i in range(6660000000,total_iterations+6660000000):
# for i in range(0, total_iterations):
    ...
    if len(words[word_iter]) > 1:
        ...
        command+='convert - ' + '-alpha set  -virtual-pixel Edge +distort SRT ' + str(rotate_image) + ' png:-| '
